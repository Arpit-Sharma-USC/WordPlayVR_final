...
public class congrats : MonoBehaviour
{
    ...
    public static void roundclearSceneAndDisplay(int currRound)
    {
        ...
        string s = "Well Done!!";
        float increment = 0f;
        float[] zPos = { 1.5f, 3.25f, 4.23f, 5.06f, 4.98f, 7.92f, 8.91f, 9.81f, 10.93f, 11.81f, 12.38f, 14.05f, 14.71f, 16.07f, 17.37f, 18.87f, 20.00f };
